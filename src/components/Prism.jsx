...
const Prism = ({
  ...
  timeScale = 0.5,
  // Perf knobs. maxDpr caps the render resolution (2 = full retina, 1 = half
  // the pixels in each axis, so a quarter of the work). steps is the raymarch
  // count per pixel — the single most expensive number in the shader.
  maxDpr = 1.5,
  steps = 100
}) => {
  ...
  useEffect(() => {
    ...
    const STEPS_N = Math.max(8, Math.round(steps));
